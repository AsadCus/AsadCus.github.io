<?php
include 'connect.php';
    $id_iv = $_GET['id_inventori'];
    $sql = "SELECT * FROM inventori WHERE id_inventori='$id_iv'";
        ...
        <main>
            <div class="container">
                <form action="edit.php" method="POST">
                    <input type="hidden" name="id_inventori" value="<?php echo $barang['id_inventori']?>"/>
                    <input type="hidden" name="id_barang" value="<?php echo $barang['id_barang']?>"/>
                    <div class="form_group">
                        <label>Jumlah</label>
                        <input class="form_field" type="number" name="jumlah_barang" value="<?php echo $barang['jumlah_barang']?>">
                    </div>
                    <div class="form_group">
                        <label>Pengembalian</label>
                        <select class="form_field" name="kondisi" id="kondisi" value="<?php echo $barang['kondisi']?>">
                            <option value="BAIK">
                                BAIK
                            </option>
                            <option value="RUSAK">
                    ...
                    <input type="submit" name="simpaninventori" value="Ubah" class="button button-main"/>
                </form>
            </div>
        </main>
    </div>
