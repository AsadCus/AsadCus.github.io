            ...
            <div class="container">
                <form action="edit.php" method="POST">
                    ...
                    <div class="form_group">
                        ...
                        <input class="form_field" type="text" name="nama_barang" value="<?php echo $barang['nama_barang']?>">
                    </div>
                    <input type="submit" name="simpanbarang" value="Ubah" class="button button-main"/>
                </form>
            </div>
        </main>
    </div>
