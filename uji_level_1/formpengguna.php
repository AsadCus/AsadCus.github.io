<?php
include 'connect.php';
$no_p = $_GET['no_pengguna'];
$sql = "SELECT * FROM pengguna WHERE no_pengguna='$no_p'";
        ...
        <main>
            <div class="container">
                <form action="edit.php" method="POST">
                    <input type="hidden" name="no_pengguna" value="<?php echo $pengguna['no_pengguna']?>">
                    <div class="form_group">
                        <label>Nama</label>
                        <input class="form_field" type="text" name="nama_pengguna" value="<?php echo $pengguna['nama_pengguna']?>">
                    </div>
                    <div class="form_group">
                        <label>Kategori</label>
                        <select class="form_field" name="kategori" id="kategori" value="<?php echo $pengguna['kategori']?>">
                            <option value="Murid">
                                Murid
                            </option>
                            <option value="Guru">
                    ...
                    <input type="submit" name="simpanpengguna" value="Ubah" class="button button-main"/>
                </form>
            </div>
        </main>
    </div>
